...
class EnvironmentVariableUtils {
    ...
    private static void setInProcessEnvironmentClass(Consumer<Map<String, String>> consumer) throws ReflectiveOperationException {
        ...
        Map<String, String> theCaseInsensitiveEnvironment = getFieldValue(processEnvironmentClass, null, "theCaseInsensitiveEnvironment");
    ...
    private static void setInSystemEnvClass(Consumer<Map<String, String>> consumer) throws ReflectiveOperationException {
        //NOSONAR access required to implement the extension
    ...
    private static Map<String, String> getFieldValue(Class<?> clazz, Object object, String name) throws ReflectiveOperationException {
        ...
        try {
            //NOSONAR illegal access required to implement the extension
            field.setAccessible(true);
        } catch (InaccessibleObjectException ex) {
            throw new PreconditionViolationException("Cannot access and modify JDK internals to modify environment variables. " + "Have a look at the documentation for possible solutions: " + "https://junit-pioneer.org/docs/environment-variables/#warnings-for-reflective-access", ex);
        }
